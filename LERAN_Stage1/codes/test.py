...
for test_loader in test_loaders:
    ...
    #ave_ms_ssim_y_lr = sum(test_results['ms_ssim_y_lr']) / len(test_results['ms_ssim_y_lr'])
    
    #logger.info(
    #    '----Average HR MS-SSIM-Y results for {}----\n\tMS-SSIM: {:.6f}. Decoded LR MS-SSIM-Y: {:.6f}.\n'.format(
    #       test_set_name, ave_ms_ssim_y, ave_ms_ssim_y_lr))    
    logger.info(
